...
knitr::include_graphics("images/latlong.png")
...
knitr::include_graphics("images/latlong2.png")
...
.pull-right[
```{r eval = T, echo = F, out.width="100%", fig.align='center'}
knitr::include_graphics("images/brazil_solo.png")
```
]
---
...
.pull-right[
```{r eval = T, echo = F, out.width="100%", fig.align='center'}
knitr::include_graphics("images/brazil_sam.png")
```
...
.pull-right[
```{r eval = T, echo = F, out.width="100%", fig.align='center'}
knitr::include_graphics("images/brazil_subnat.png")
```
...
knitr::include_graphics("images/chicago_gov_schools.png")
